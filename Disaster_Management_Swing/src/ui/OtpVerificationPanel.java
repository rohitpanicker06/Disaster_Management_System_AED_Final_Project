...
public class OtpVerificationPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        resendOTPButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                resendOTPButtonActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(51, 51, 51)
                        .addComponent(resendOTPButton, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(71, 71, 71)
    ...
    private void resendOTPButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resendOTPButtonActionPerformed
        
        try {
            int newOtp = emailSendingService.SendEmail.sendEmail(userName, emailId);
            this.otp = newOtp;
            JOptionPane.showMessageDialog(this, "Otp RE-SENT");
            Integer otp =Integer.valueOf(optTxtField.getText());
        if(otp.intValue() == this.otp.intValue())
        {
            JOptionPane.showMessageDialog(this, "Sign Up Successfull");
        ...
        return;
    }//GEN-LAST:event_resendOTPButtonActionPerformed
