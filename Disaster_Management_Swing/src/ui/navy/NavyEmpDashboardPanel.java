...
public class NavyEmpDashboardPanel extends javax.swing.JPanel {

    /**
     * Creates new form NavyEmpDashboardPanel
     */
    ...
    public NavyEmpDashboardPanel() {
        initComponents();
        setOpaque(false);
      
    }
    
    public NavyEmpDashboardPanel(int i ) {
        initComponents();
        setOpaque(false);
        populateFields();
    ...
    public void populateFields() {
        ...
        NavyEmployee currentEmp = null;

        for (NavyEmployee armEmp : NavyEmployeeDirectory.empList) {
        ...
        if (currentEmp.getCrReports() != null) {
            for (CivilResponseReport crReport : currentEmp.getCrReports()) {
